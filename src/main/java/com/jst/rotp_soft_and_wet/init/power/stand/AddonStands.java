...
public class AddonStands {
    ...
    public static final DeferredHolder<StandType, EntityStandType> SOFT_AND_WET = STANDS.register("soft_and_wet", StandInitSoftAndWet::create);

    public static final DeferredHolder<StandType, EntityStandType> PAISLEY_PARK = STANDS.register("paisley_park", StandInitPaisleyPark::create);

    public static final DeferredHolder<StandType, EntityStandType> KILLER_QUEEN_8 = STANDS.register("killer_queen_8", StandInitKillerQueen8::create);
